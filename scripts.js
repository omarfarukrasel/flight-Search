var FlightSearch = {
  init: function(){
    f1 = new Flight("Biman Bangladesh","1234","CHA","DHA",1000,1402649480000);
    f2 = new Flight("Biman Bangladesh","8966","CHA","JHR",2000,1402649480000);
    f3 = new Flight("Biman Bangladesh","999", "DHA","BRL",3000,1402649480000);
    f4 = new Flight("US Bangla","MH-370","BRL","KMU",4000,1402649480000);
    f5 = new Flight("US Bangla","111", "JHR","DHA",5000,1402649480000);
    f6 = new Flight("US Bangla","5678","CHA","DHA",1200,1402649480000);
    f7 = new Flight("US Bangla","7545","DHA","CHA",1200,1402649480000);
  },
